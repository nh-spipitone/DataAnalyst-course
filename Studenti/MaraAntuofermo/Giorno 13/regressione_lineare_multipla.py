...
print(
    "Per ogni unità di superficie in più, il prezzo aumenta di circa {:.2f} €.".format(
        coefficients[0]
    )
)
print(
    "Per ogni stanza in più, il prezzo aumenta di circa {:.2f} €.".format(
        coefficients[1]
    )
)
print(
    "Per ogni anno in più di età della casa, il prezzo diminuisce di circa {:.2f} €.".format(
        coefficients[2]
    )
)
