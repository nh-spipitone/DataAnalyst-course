...
media_voti_alunno = df[["Matematica", "Italiano", "Storia"]].mean(axis = 1)              #axis = 1 per calcolare la media per riga invece che per colonna
...
alunni_migliori = df.loc[media_voti_alunno == media_alunno_migliore, "None"]
